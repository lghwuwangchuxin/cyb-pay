...
public class OrderUnpayRsp extends com.parking.dtosh.BaseRsp {
	@XmlElement
	private String syncId;//支付请求唯一序列号，由运营商生成
	@XmlElement
	private String appId;//应用商户代码，由智慧通行平台分配
	@XmlElement
	private String industryCode;//停车场对应的商户号
	@XmlElement
	private String plateNumber;//车牌号
	@XmlElement
	private String orderId;//订单号，由运营商生成
	@XmlElement
	private String payAmount;//实际支付费用，精确到分，以分为单位
	@XmlElement
	private String serviceAmount;//总金额，精确到分，以分为单位
	@XmlElement
	private String orderDate;//订单生成时间
	@XmlElement
	private String startTime;//车辆进入停车场时间
	@XmlElement
	private String endTime;//车辆离开停车场时间
	@XmlElement
	...
	public String toString() {
		return "OrderUnpayRsp [syncId=" + syncId + ", appId=" + appId + ", industryCode=" + industryCode
				+ ", plateNumber=" + plateNumber + ", orderId=" + orderId + ", payAmount=" + payAmount
				+ ", serviceAmount=" + serviceAmount + ", orderDate=" + orderDate + ", startTime=" + startTime
				+ ", endTime=" + endTime + ", parkId=" + parkId + ", parkName=" + parkName + ", payCallback="
				+ payCallback + ", accSplitData=" + accSplitData + "]";
	}
