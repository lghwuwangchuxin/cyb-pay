...
public class ObjectToLinkHMap2 {
	private static final String JAVAP = "java.";
	private static final String JAVADATESTR = "java.util.Date";


	public static LinkedHashMap<String, Object> objectToMapString(String timeFormatStr, Object obj,
     ...
     */
	private static LinkedHashMap<String, Object> objectTransfer(String timeFormatStr, Object obj,
			LinkedHashMap<String, Object> map, List<String> excludeFields) throws IllegalAccessException {
