...
public class SecretUtils {
	...
	public static final String Private_Key = "demoEwUt%2BQecIMjU6d5s0OQ%3D%3D";
	...
	public static String decryptMode(String message, String key)
		...
		try {
			...
			desMessage = new String(resultByte,"UTF-8");
		} catch (java.security.NoSuchAlgorithmException e1) {
			e1.printStackTrace();
		} catch (javax.crypto.NoSuchPaddingException e2) {
			e2.printStackTrace();
	...
	public static void main(String[] args) throws UnsupportedEncodingException,
		...
		// 加密
		String secretArr = SecretUtils.encryptMode(msg.getBytes(),
				"demoEwUt%2BQecIMjU6d5s0OQ%3D%3D");
		System.err.println(secretArr);

		String message = "oO%2BqWukvM%2Brpa46HFLkdwA%3D%3D";
		// // 解密
		String myMsgArr = SecretUtils.decryptMode(message,
				"demoEwUt%2BQecIMjU6d5s0OQ%3D%3D");
